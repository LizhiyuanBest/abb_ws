...
class Robot:
    ...
    def set_cartesian_t(self, pose, t):
        '''
        Executes a move immediately from the current pose,
        to 'pose', with units of millimeters.
        '''
        msg  = "10 " + format(t, "+08.4f") + " " + self.format_pose(pose) 
        return self.send(msg)

    def set_cartesian_v(self, pose, v):
        '''
        Executes a move immediately from the current pose,
        to 'pose', with units of millimeters.
        '''
        msg  = "11 " + format(v, "+08.4f") + " " + self.format_pose(pose) 
        return self.send(msg)

    # def set_cartesian_vt(self, pose, v, t): #don't work
    #     '''
    #     Executes a move immediately from the current pose,
    #     to 'pose', with units of millimeters.
    #     '''
    #     msg  = "12 " + format(v, "+08.4f") + " " + format(t, "+08.4f") + " " + self.format_pose(pose) 
    #     return self.send(msg)
    ...
    def set_joints_t(self, joints,t):
        '''
        Executes a move immediately, from current joint angles,
        to 'joints', in degrees. 
        '''
    ...
    def set_joints_v(self, joints,v):
        '''
        Executes a move immediately, from current joint angles,
        to 'joints', in degrees. 
        '''
    ...
    # def set_joints_vt(self, joints,v,t):  #don't work
    #     '''
    #     Executes a move immediately, from current joint angles,
    #     to 'joints', in degrees. 
    #     '''
    ...
    #     msg = "22 "
    #     for joint in joints: msg += format(joint*self.scale_angle, "+08.2f") + " " 
    #     msg += format(v, "+08.4f") + " " + format(t, "+08.4f") + " #"
    #     return self.send(msg)
    ...
    def set_acc(self,acc=100,ramp=100):
        msg = "88 " 
        msg += format(acc, "+08.1f") + " "
        msg += format(ramp, "+08.2f") + " #"     
        self.send(msg)
	...
	value=0, Reset; value=1,Set;
        '''
        msg = '97 ' + str(int(num)) + ' ' + str(int(bool(value))) + ' #'
        #return msg
        return self.send(msg)
