...
def grip(pos_y,pos_x,speed):
    ...
    # if (speed < 100):
    #     add_time = math.sqrt(49/(100-speed))
    
    x = 342 - (pos_x - 211) * dx
    x_time = abs(x-346)/100
    y = 0 + speed*add_time
    R.set_speed([200, 200, 100, 100])
    wait_time = (s-(pos_y-190)*dy)/speed - x_time #- add_time 
    # Ready position
    ...
    # Grip position
    R.set_cartesian([[x, 0, 194], [0.708, 0.0345, 0.704, -0.0168]]) # z=194
    rospy.sleep(0.1)
