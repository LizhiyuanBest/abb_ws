...
def grip(pos_y,pos_x,speed):
    ...
    # Grip position
    R.set_cartesian([[x, 100, 194], [0.708, 0.0345, 0.704, -0.0168]]) # z=194
    rospy.sleep(0.1)
    R.set_dio(doGripperOpen, 0)
    R.set_dio(doGripperClose, 1)
    R.set_cartesian([[346, 100, 212], [0.708, 0.0345, 0.704, -0.0168]])


def place(TYPE):
    R.set_speed([200, 200, 100, 100])
    # Ready position
    R.set_cartesian([[352, 100, 212], [0.708, 0.0345, 0.704, -0.0168]])
    R.set_cartesian([[352, 100, 398], [0.708, 0.0345, 0.704, -0.0168]])
